...
public class BetAdvisorEmailParser {
	...
	public static BetAdvisorTip parseTip(String cleanedMail){
		/* Create result object */
	...
	public static void main(String[] args) {
		...
		List<ParsedTextMail> mails = reader.read("noreply@betadvisor.com", 500);
		...
		for(int i = 0; i < tips.size(); i++){
			System.out.println(tips.get(i).typeOfBet);
			...
			if(tips.get(i).typeOfBet.equalsIgnoreCase("Over / Under Team") || tips.get(i).typeOfBet.equalsIgnoreCase("Over / Under 1st Half Team")){
				out++;
			}
		}
		stake /= tips.size();
